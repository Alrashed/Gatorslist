...
<!--              <p>+ First name   : --><?php //if (isset($user->Firstname)) echo htmlspecialchars($user->Firstname, ENT_QUOTES, 'UTF-8'); ?><!--</p></br>-->
<!--              <p>+ Last name    : --><?php //if (isset($user->Lastname)) echo htmlspecialchars($user->Lastname, ENT_QUOTES, 'UTF-8'); ?><!--</p></br>-->
<!--              <p>+ Account email: --><?php //if (isset($user->Email)) echo htmlspecialchars($user->Email, ENT_QUOTES, 'UTF-8'); ?><!--</p></br>-->
<!--            </div>-->
