<div class="container" style="width:80%; margin-left:10%; margin-top:1%">
     <div class="panel panel-default" style="background:#f7f7f7">
        <div class="panel-heading" style="background:#d0d0d0">Recently Added Items</div>
		    ...
		    <div class="panel-body meta-style" style="float:left; margin-top: -5%; margin-left:5%; width:100%">
            		     <div class="row">
                         ...
                         <div class=" " style="float:left; margin-left: 1%"> <?php if (isset($product->Postdate)) echo htmlspecialchars($product->Postdate, ENT_QUOTES, 'UTF-8'); ?></div>
                         </div></br>
