<div class="jumbotron">
    ...
    <div class="row text-center">
        ...
        <div class="col-lg-offset-0" style="float:left;"><form action="<?php echo URL . 'confirm/reConfirm/' . htmlspecialchars($productDetail->Product_id, ENT_QUOTES, 'UTF-8'); ?>"><button class="view-item-button" > Pay in Advance</button></div></form>
