...
<div class="row text-center">
  <h2><?php if (isset($productDetail->Title)) echo htmlspecialchars($productDetail->Title, ENT_QUOTES, 'UTF-8'); ?> - $<?php if (isset($productDetail->Price)) echo htmlspecialchars($productDetail->Price, ENT_QUOTES, 'UTF-8'); ?></h2>
    ...
    <br><br>
    <p><a class="btn btn-warning btn-lg" href="<?php echo URL; ?>contact/index" role="button">Contact Seller</a></p>
    <p>"Contact the seller to arrange a time to meet up and purchase the item."</p>
    <p>-Or-</p>
  <p><a class="btn btn-warning btn-lg" href="<?php echo URL . 'confirm/reConfirm/' . htmlspecialchars($productDetail->Product_id, ENT_QUOTES, 'UTF-8'); ?>" role="button">Pay in Advance</a></p>
