<div class="row" style="width:80%; margin-left:10%;opacity: 1;padding: 5%;border-radius: 5px;padding-bottom: 5vh;">
        ...
        <a href="#" class="thumbnail" >
          ...
          <img  <?php if (isset($productDetail->Image_blob4) && $productDetail->Image_blob4 != "")
            echo 'src="data:image/jpeg;base64,'.base64_encode($productDetail->Image_blob4).'" height="800" width="600"';?> >
              ...
              <h5>Seller&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;: <?php if (isset($productDetail->Seller_id)) echo htmlspecialchars($productDetail->Seller_id, ENT_QUOTES, 'UTF-8'); ?></h5>
