<div class="row" style="width:80%; margin-left:10%;height: 30vh;">
            ...
            <div class="row">
                ...
                <div class="col-sm-4">
                    ...
                    <div class="panel-body meta-style" style="float:left; margin-top: -5%; width:100%">
                     ...
                     <div class=" " style="float:left;"> <?php if (isset($product->Postdate)) echo htmlspecialchars(date("Y-m-d", strtotime($product->Postdate)), ENT_QUOTES, 'UTF-8'); ?></div></br></br>
