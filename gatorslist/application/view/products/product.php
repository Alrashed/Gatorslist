             ...
             <?php foreach ($products as $product) { ?>
                    <div class="col-lg-3 " style="background:;padding-left:1vw;padding-right:1vw; margin-top:4vh">
                        ...
                        <div class="col-lg-12" style="float:left;  width:100%;background:">
                                <div class="col-lg-12 col-lg-offset-0" style="background:#FFFFFF;font-size:17px;font-weight:bold;padding-top:1vh;padding-bottom:1vh;margin-right:1vw"> <?php if (isset($product->Title)) echo htmlspecialchars($product->Title, ENT_QUOTES, 'UTF-8'); ?></div>
