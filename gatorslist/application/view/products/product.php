        ...
        <form action="<?php echo URL; ?>products/searchproducts" method="GET">
             ...
             <?php foreach ($products as $product) { ?>
                    <div class="col-lg-3 " style="background:;padding-left:1vw;padding-right:1vw; margin-top:4vh">
                        ...
                        <div class="panel-body col-lg-12" style="background:;padding-bottom:0;padding-right:0"><a href="<?php echo URL . 'item/showitem/' . htmlspecialchars($product->Product_id, ENT_QUOTES, 'UTF-8'); ?>"><img  <?php if (isset($product->Image_blob1) && $product->Image_blob1 != "")
                        ...
                        <div class="col-lg-11" style="float:left;  width:100%;background:">
