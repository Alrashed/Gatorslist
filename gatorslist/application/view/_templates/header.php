                      ...
                      <div class="margin-right-1 float-left">
                        <select  name="category" class="form-control">
                            ...
                            <?php foreach ($categories as $category) { ?>
                                <option value= "<?php if (isset($category->Category_name)) echo htmlspecialchars($category->Category_name, ENT_QUOTES, 'UTF-8'); ?>" <?php if($_GET['category']==($category->Category_name)) echo 'selected="selected"'; ?>><?php if (isset($category->Category_name)) echo htmlspecialchars($category->Category_name, ENT_QUOTES, 'UTF-8'); ?></option>
